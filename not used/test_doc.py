...
def main():
    ...
    try:
        ...
        # --- 1. Define the content for the document ---
        doc_title = "My Awesome Research Submission"
        ...
        # Data for the "Information" section (formerly a table)
        info_data = [
        ...
        # --- 2. Create a new Google Doc with a title ---
        print(f"Creating new document titled: '{doc_title}'")
        ...
        # =================================================================
        # === MODIFIED SECTION: Create bolded key-value pairs instead of a table
        # =================================================================
        ...
        # Add a newline for spacing after the list
        insert_text("\n", "NORMAL_TEXT")
        # =================================================================
        ...
        # --- 4. Execute the batch update to add all content ---
